...
const Mcdonalds= () => {
  ...
  useEffect(() => {
    fetchmcdonaldsProducts();
  }, []);

  const fetchmcdonaldsProducts = async () => {
    setLoading(true);
    try {
      const response = await axios.get(
        "http://localhost:5000/user/products/category/mcdonalds",
