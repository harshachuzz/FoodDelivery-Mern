...
import Scoopscarousel from './Scoopscarousel';
...
const Scoops= () => {
  ...
  const fetchScoopsProducts = async () => {
    setLoading(true);
    try {
      const response = await axios.get(
        "http://localhost:5000/user/products/category/Scoops",
  ...
  return (
    <div>
      <Scoopscarousel /> {/* Move Scoopscarousel to the top */}
